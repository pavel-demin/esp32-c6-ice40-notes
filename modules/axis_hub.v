...
(
  ...
  output wire [16:0]               b00_bram_addr,
  ...
  output wire [16:0]               b01_bram_addr,
  ...
  output wire [16:0]               b02_bram_addr,
  ...
  output wire [16:0]               b03_bram_addr,
  ...
  output wire [16:0]               b04_bram_addr,
  ...
  output wire [16:0]               b05_bram_addr,
  ...
  wire [19:0] int_awaddr_wire;

  wire int_wlast_wire;
  wire [31:0] int_wdata_wire;

  wire [9:0] int_arlen_wire;
  wire [19:0] int_araddr_wire;
  ...
  wire [16:0] int_waddr_wire;
  wire [16:0] int_raddr_wire;
  ...
  assign s_axis_awvalid = s_axis_tvalid & s_axis_tdata[30];
  assign s_axis_wvalid = s_axis_tvalid & ~s_axis_awready;
  assign s_axis_arvalid = s_axis_tvalid & ~s_axis_tdata[30] & s_axis_awready;
  ...
  assign int_waddr_wire = int_awaddr_wire[16:0] + int_awcntr_reg;
  assign int_raddr_wire = int_araddr_wire[16:0] + int_arcntr_reg;

  assign int_rdata_wire[0] = int_rdata_mux[int_araddr_wire[19:17]];
  ...
  generate
    ...
    begin : SELECTS
      assign int_wsel_wire[j] = int_we_wire & (int_awaddr_wire[19:17] == j);
      assign int_rsel_wire[j] = int_re_wire & (int_araddr_wire[19:17] == j);
    end
  endgenerate
  ...
  assign s_axis_tready = s_axis_awready ? s_axis_tdata[30] | s_axis_arready : s_axis_wready;
